<template>
  <div class="home">
    ...
    <div class="second-line">
      <router-link :to="`/test`">화면 이동</router-link>
    </div>
    <div class="line">
      ...
      <input type="checkbox" id="toms" value="Toms" v-model="checkedNames" />
...
export default {
  computed: {
    checkNames() {
      return (this.checkedNames.length > 0) ? this.checkedNames : "None";
    }
  },
  data() {
    return {
